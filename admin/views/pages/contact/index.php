                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-secondary" href="index.php?option=contact&act=trash">
                                ...
                                <tbody>
                                    <?php foreach ($list_contact as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info" href="index.php?option=contact&act=update&id=<?= $row['id']; ?>" style="width:80%; margin:2%"><i class="fa fa-edit"></i> Trả lời</a>
                                                <a class="btn btn-sm btn-danger" href="index.php?option=contact&act=deltrash&id=<?= $row['id']; ?>" style="width:80%; margin:2%"><i class="fa fa-trash"></i> Lưu trữ</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
