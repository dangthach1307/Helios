<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=rank">Danh mục cấp bậc</a></li>
    ...
    <section class="content">
        <form action="index.php?option=rank&act=insert" method="post" enctype="multipart/form-data">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title font-weight-bold py-2">Tạo cấp bậc</h3>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control custom-select">
                                    <option selected>[--- Trạng thái cấp bậc ---]</option>
