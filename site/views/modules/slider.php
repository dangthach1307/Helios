<div class="container jtv-home-revslider">
    <div class="row">
        <div class="col-lg-9 col-sm-9 col-xs-12 jtv-main-home-slider">
            <div id='rev_slider_1_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
                <div id='rev_slider_1' class='rev_slider fullwidthabanner'>
                    <ul>
                        <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='../public/images/slider/slide1.jpg'><img src='../public/images/slider/slide1.jpg' alt="slider image1" data-bgposition='center center' data-bgfit='cover' data-bgrepeat='no-repeat' />
                            <!-- <div class="info">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="banner-block"> <a href="#"> <img src="../public/images/banner/banner1.jpg" alt="" style="height:250px;width:100%"> </a>
            ...
            <div class="banner-block"> <a href="#"> <img src="../public/images/banner/banner2.jpg" alt="" style="height:225px;width:100%"> </a>
                <div class="text-des-container">
                    <div class="text-des">
                        <p>Mặt dây chuyền</p>
                        <h2>Tự thiết kế</h2>
