                        ...
                        <div class="text-center">
                            <ul class="nav jtv-heading-style" role="tablist">
                                <li role="presentation" class="">
                                    <a href="#cart" aria-controls="cart" role="tab" data-toggle="tab">1 Shopping cart</a>
                                </li>
                                <li role="presentation" class="">
                                    <a href="#checkout" aria-controls="checkout" role="tab" data-toggle="tab">2 Checkout</a>
                                </li>
                                <li role="presentation" class="active">
                                    <a href="#complete-order" aria-controls="complete-order" role="tab" data-toggle="tab">3 Complete Order</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="shop-cart-table">
                                                ...
                                                <tbody>
                                                    <tr class="cart_item">
                                                        <td class="item-img">
                                                            <a href="#"><img src="images/products/product-fashion-1.jpg" alt="Product tilte is here " />
                                                            </a>
                                                        </td>
                                                        <td class="item-title">
                                                            <a href="#">Product tilte is here </a>
                                                        </td>
                                                ...
                                                <div class="col-md-8 col-sm-7 col-xs-12">
                                                    <div class="update-coupne-area">
                                                        <div class="update-continue-btn text-right">
                                                            ...
                                                            <button class="button btn-empty" title="Clear Cart" value="empty_cart" name="update_cart_action" type="submit">
                                                        ...
                                                        <div class="coupn-area">
                                                            <div class="discount">
                                                                ...
                                                                <label for="coupon_code">Enter your coupon code if you have
                                                                    one.</label>
                                                                <input type="hidden" value="0" id="remove-coupone" name="remove" />
                                                                <input type="text" value="" name="coupon_code" id="coupon_code" class="input-text fullwidth" />
                                                                <button value="Apply Coupon" onclick="discountForm.submit(false)" class="button coupon" title="Apply Coupon" type="button">
                                                    ...
                                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                                        ...
                                                        <div class="panel panel-checkout">
                                                            <div class="panel-heading" role="tab" id="headingThree">
                                                                <h4 class="panel-title">
                                                                    <img src="images/acc.jpg" alt="" /> Have
                                                                    A Coupon?
                                                        ...
                                                        <table class="checkout-area table">
                                                            ...
                                                            <tbody>
                                                                <tr class="cart_item check-item prd-name">
                                                                    <td class="ctg-type">
                                                                        Product tilte is here × <span>1</span>
                                                                    </td>
